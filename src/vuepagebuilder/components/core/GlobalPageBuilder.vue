<template>
  <div :class="{'page-builder':true,'edit':editPage}">
    <div class="component-wrapper" v-for="component in componentStructure(gui)">
      <div style="display: flex; justify-content: space-between" v-if="editPage">
        ...
        <div style="display: flex; border-radius: 50px; justify-content: end;">
          <component-form :is-global="true"  :componentModel="component" :gui="gui"></component-form>
    ...
    <component-form v-if="editPage" :is-global="true" :gui="gui"></component-form>
  </div>
</template>
...
export default {
  name: "GlobalPageBuilder",
  mixins:[globalPageBuilderStoreMixin, pageBuilderMixin]
}
</script>
